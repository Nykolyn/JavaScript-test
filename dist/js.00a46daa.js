...
var StringBuilder = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(StringBuilder, [{
    ...
    value: function append(str) {
      ...
      this.baseString = [].concat((0, _toConsumableArray2.default)(this.baseString), (0, _toConsumableArray2.default)(str)).join("");
      return this;
    }
  }, {
    key: "prepend",
    value: function prepend(str) {
      if (!str) throw new Error("No value was passed");
      this.baseString = [].concat((0, _toConsumableArray2.default)(str), (0, _toConsumableArray2.default)(this.baseString)).join("");
      return this;
    }
  }, {
    key: "pad",
    value: function pad(str) {
      if (!str) throw new Error("No value was passed");
      this.baseString = [].concat((0, _toConsumableArray2.default)(str), (0, _toConsumableArray2.default)(this.baseString), (0, _toConsumableArray2.default)(str)).join("");
      return this;
    }
  }]);
...
},{"../helpers/getRandomRGBColor":"js/helpers/getRandomRGBColor.js"}],"js/task-2/index.js":[function(require,module,exports) {
"use strict";
...
},{"./vue":"js/task-2/vue.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
/**
...
},{"./task-1":"js/task-1/index.js","./task-2":"js/task-2/index.js","./task-3":"js/task-3/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
